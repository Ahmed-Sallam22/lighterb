...
const AddIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 0C10.5523 0 11 0.447715 11 1V9H19C19.5523 9 20 9.44772 20 10C20 10.5523 19.5523 11 19 11H11V19C11 19.5523 10.5523 20 10 20C9.44772 20 9 19.5523 9 19V11H1C0.447715 11 0 10.5523 0 10C0 9.44772 0.447715 9 1 9H9V1C9 0.447715 9.44772 0 10 0Z" fill="white"/>
  </svg>
);
...
const SegmentsPage = () => {
  ...
  const toggleRequired = async (segment) => {
    try {
      await dispatch(updateSegmentType({
              ...
              >
                  ...
                  <div className="flex items-center gap-1 text-[#1A7A99]">
                    ...
                    >
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.1133 6.66671C10.3878 5.88991 11.1287 5.33337 11.9995 5.33337C12.8703 5.33337 13.6111 5.88991 13.8857 6.66671" stroke="#757575" strokeLinecap="round"/>
                        <path d="M17.6674 8H6.33398" stroke="#757575" strokeLinecap="round"/>
                        <path d="M16.5545 9.66663L16.2478 14.266C16.1298 16.036 16.0708 16.9209 15.4942 17.4605C14.9175 18 14.0306 18 12.2567 18H11.7411C9.96726 18 9.08033 18 8.50365 17.4605C7.92698 16.9209 7.86798 16.036 7.74999 14.266L7.44336 9.66663" stroke="#757575" strokeLinecap="round"/>
                        <path d="M10.334 11.3334L10.6673 14.6667" stroke="#757575" strokeLinecap="round"/>
                        <path d="M13.6673 11.3334L13.334 14.6667" stroke="#757575" strokeLinecap="round"/>
                      </svg>
                    </button>
                  </div>
                </div>
                ...
                <div className="mt-3 flex flex-wrap gap-4">
                  ...
                  >
                    ...
                    >
                      {segment.is_required && (
                        <svg width="10" height="8" viewBox="0 0 13 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M1 4.5L4.5 8L12 1"
                            stroke="white"
                            strokeWidth="1.5"
      ...
      >
        <div className="space-y-4">
          ...
          <FloatingLabelInput
            ...
            placeholder={selectedSegmentTypeLength ? `Enter ${selectedSegmentTypeLength} characters` : 'Enter code'}
          />
          {selectedSegmentTypeLength && (
            <p className="text-xs text-gray-500 mt-1 px-1">
              Required length: {selectedSegmentTypeLength} characters 
              {valueFormData.code && (
                <span className={valueFormData.code.length === selectedSegmentTypeLength ? 'text-green-600 font-semibold' : 'text-orange-600 font-semibold'}>
