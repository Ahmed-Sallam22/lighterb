...
const HeroPattern = () => (
<svg className="pointer-events-none absolute  " width="871" height="322" viewBox="0 0 871 322" fill="none" xmlns="http://www.w3.org/2000/svg">
<g opacity="0.1">
...
<g opacity="0.5">
<path d="M18.3834 263.045L52.9843 273.755L-16.53 296.535L18.3834 263.045Z" stroke="#28819C" stroke-width="3"/>
<path d="M3.95954 -27.7887L38.5604 -17.079L-30.9538 5.70101L3.95954 -27.7887Z" stroke="#28819C" stroke-width="3"/>
<path d="M-10.5961 206.382L27.6497 199.483L-26.3255 249.003L-10.5961 206.382Z" stroke="#28819C" stroke-width="3"/>
<path d="M113.076 196.198L116.141 229.722L65.3326 180.103L113.076 196.198Z" stroke="#28819C" stroke-width="3"/>
<path d="M-8.28617 127.401L-37.0226 167.353L-36.158 70.0641L-8.28617 127.401Z" stroke="#28819C" stroke-width="3"/>
<path d="M290.992 284.036L294.057 317.561L243.249 267.942L290.992 284.036Z" stroke="#28819C" stroke-width="3"/>
<path d="M36.124 233.656L36.125 233.656L55.6962 214.878L55.5298 259.447L20.53 248.614L36.124 233.656Z" stroke="#28819C" stroke-width="3"/>
<path d="M28.9447 152.099L54.1792 163.039L7.98389 176.879L8.20654 143.105L28.9447 152.099Z" stroke="#28819C" stroke-width="3"/>
<path d="M202.35 287.603L227.584 298.543L181.389 312.383L181.612 278.609L202.35 287.603Z" stroke="#28819C" stroke-width="3"/>
<path d="M138.982 252.033L166.036 244.613L141.805 283.258L117.246 257.992L138.982 252.033Z" stroke="#28819C" stroke-width="3"/>
<path d="M94.0883 317.309L70.3921 276.017L107.302 274.416L94.0883 317.309Z" stroke="#28819C" stroke-width="3"/>
</g>
</g>
</g>
</svg>
      ...
      <PageHeader
        ...
        icon={
          <svg width="29" height="35" viewBox="0 0 29 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.25 2.5C16.25 2.16848 16.1183 1.85054 15.8839 1.61612C15.6495 1.3817 15.3315 1.25 15 1.25H2.5C2.16848 1.25 1.85054 1.3817 1.61612 1.61612C1.3817 1.85054 1.25 2.16848 1.25 2.5V10.625C1.24854 11.8715 1.58661 13.0948 2.2279 14.1637C2.86919 15.2325 3.7895 16.1066 4.89 16.6919L8.125 18.4169V17L5.47875 15.5887C4.57853 15.1096 3.82568 14.3945 3.30093 13.52C2.77618 12.6456 2.49931 11.6448 2.5 10.625V2.5H15V8.125H16.25V2.5Z" fill="#28819C"/>
          </svg>
        }
      />
      ...
      >
        {lines.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-[#b6c4cc] bg-[#f5f8fb] p-6 text-center text-[#567086]">
            ...
            <p className="text-sm mb-6">GL distribution lines are required to post this journal entry.</p>
            <button
              type="button"
              onClick={handleAddLine}
                  ...
                  <td colSpan="2" className="px-4 py-3">
                    {isBalanced ? (
                      ...
                      <span className="inline-flex items-center gap-1 text-red-600 text-sm font-medium">
                        ...
                        Not Balanced (Diff: {Math.abs(totalDebit - totalCredit).toFixed(2)})
                      </span>
                    )}
                  </td>
                </tr>
