...
const DeleteIcon = () => (
  <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12.3329 8.6191C12.4813 8.19853 12.7565 7.83434 13.1206 7.57673C13.4846 7.31912 13.9196 7.18079 14.3656 7.18079C14.8116 7.18079 15.2466 7.31912 15.6107 7.57673C15.9748 7.83434 16.25 8.19853 16.3983 8.6191M20.471 10.0557H8.26025M19.2736 11.8514L18.9432 16.8075C18.8161 18.7138 18.7529 19.6669 18.1316 20.248C17.5102 20.8291 16.5542 20.8298 14.6436 20.8298H14.0876C12.177 20.8298 11.221 20.8298 10.5997 20.248C9.97838 19.6669 9.91445 18.7138 9.78803 16.8075L9.45762 11.8514M12.5699 13.6471L12.9291 17.2384M16.1613 13.6471L15.8022 17.2384" stroke="#F41A1A" strokeWidth="0.82089" strokeLinecap="round"/>
  </svg>
);
...
const Table = ({ 
  ...
  editIcon = "edit", // "edit" or "view"
  showActions, // Function to determine if actions should be shown for a row
  showDeleteButton // Function to determine if delete button should be shown for a row
}) => {
  return (
        ...
        <table className="w-full">
          ...
          <thead className="bg-[#ececec] border-b-2 border-gray-200">
            <tr>
              ...
              {/* Actions Column */}
              {(onEdit || onDelete) && (
                <th className="px-6 py-4 text-center text-sm font-semibold text-[#000000]  ">
                  Actions
                </th>
              )}
            </tr>
