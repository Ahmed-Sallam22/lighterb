      ...
      <div className="relative z-10000 w-full max-w-lg mx-4 bg-white rounded-2xl shadow-2xl transform transition-all">
        ...
        <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          ...
          <button
            type="button"
            onClick={onClose}
            className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#28819C] sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
          >
            {cancelText}
          </button>
        </div>
