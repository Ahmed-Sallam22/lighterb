...
const DepartmentNode = ({ data, isConnectable }) => {
	...
	return (
		<div
			className={`px-4 py-3 shadow-lg rounded-xl border-2 bg-white min-w-[200px] ${
		...
		>
			...
			{data.onClick && (
				...
				>
					{t("departments.tree.viewDetails")}
				</button>
			)}
