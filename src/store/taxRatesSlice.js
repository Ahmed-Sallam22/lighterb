...
export const fetchTaxRates = createAsyncThunk("taxRates/fetchAll", async (filters = {}, { rejectWithValue }) => {
	try {
		...
		const url = queryString ? `/finance/core/tax-rates/?${queryString}` : "/finance/core/tax-rates/";
...
export const createTaxRate = createAsyncThunk("taxRates/create", async (taxRateData, { rejectWithValue }) => {
	try {
...
export const updateTaxRate = createAsyncThunk("taxRates/update", async ({ id, data }, { rejectWithValue }) => {
	try {
...
export const deleteTaxRate = createAsyncThunk("taxRates/delete", async (id, { rejectWithValue }) => {
	try {
...
export const toggleTaxRateActive = createAsyncThunk("taxRates/toggleActive", async (id, { rejectWithValue }) => {
	try {
...
// Seed presets
export const seedTaxPresets = createAsyncThunk("taxRates/seedPresets", async (_, { rejectWithValue }) => {
	try {
...
export const corporateFiling = createAsyncThunk("taxRates/corporateFiling", async (id, { rejectWithValue }) => {
	try {
...
export const corporateFile = createAsyncThunk("taxRates/corporateFile", async (id, { rejectWithValue }) => {
	try {
...
export const corporateReverse = createAsyncThunk("taxRates/corporateReverse", async (id, { rejectWithValue }) => {
	try {
